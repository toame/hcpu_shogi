...
int main(int argc, char* argv[]) {
	...
	try {
		options.add_options()
			...
			("search_param1", "search_param1", cxxopts::value<float>(search_level[0][0])->default_value("0.20"), "num")
			("search_param2", "search_param2", cxxopts::value<float>(search_level[0][1])->default_value("0.30"), "num")
			("search_param3", "search_param3", cxxopts::value<float>(search_level[0][2])->default_value("0.45"), "num")
			("search_param21", "search_param1", cxxopts::value<float>(search_level[1][0])->default_value("0.30"), "num")
			("search_param22", "search_param2", cxxopts::value<float>(search_level[1][1])->default_value("0.45"), "num")
			("search_param23", "search_param3", cxxopts::value<float>(search_level[1][2])->default_value("0.65"), "num")
