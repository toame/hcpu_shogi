...
auto hcp_2pieces = position_2pieces->toHuffmanCodedPos();
auto hcp_4pieces = position_4pieces->toHuffmanCodedPos();
auto hcp_6pieces = position_6pieces->toHuffmanCodedPos();
...
int main(int argc, char* argv[]) {
	...
	try {
		options.add_options()
			...
			("black_expect_failed_param1", "black_expect_failed_param1", cxxopts::value<float>(search_level[0][0])->default_value("0.20"), "num")
			("black_expect_failed_param2", "black_expect_failed_param2", cxxopts::value<float>(search_level[0][1])->default_value("0.30"), "num")
			("black_expect_failed_param3", "black_expect_failed_param3", cxxopts::value<float>(search_level[0][2])->default_value("0.45"), "num")
			("search_param21", "black_expect_failed_param1", cxxopts::value<float>(search_level[1][0])->default_value("0.30"), "num")
			("search_param22", "black_expect_failed_param2", cxxopts::value<float>(search_level[1][1])->default_value("0.45"), "num")
			("search_param23", "black_expect_failed_param3", cxxopts::value<float>(search_level[1][2])->default_value("0.65"), "num")
